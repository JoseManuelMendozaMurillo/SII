document.addEventListener("DOMContentLoaded", function() {
    ...
    btnOpenModalDelete.forEach((btn) => {
        btn.addEventListener("click", (event) => {
            ...
            const nameAlumnoDelete = document.getElementById(`nameAlumno${idAlumnoDelete}`).textContent;
    ...
    function openModalDelete(idAlumnoDelete, nameAlumnoDelete){
        ...
        btnDeleteAlumno.setAttribute("href", `${url}alumno/delete/${idAlumnoDelete}`);
        modalDelete.show();
    }
