...
class Alumno extends BaseController {
    ...
    public function form($id=""){
        ...
        $data = [
            "carreras" => $CarrerasModel->get_all()
        ];
        if($id != ""){
            ...
            $data += [
                "alumno" => $alumno,
                "grupos" => $GruposModel->get_by($alumno->id_carrera, $alumno->semestre)
            ];
        }
        ...
        if(!$this->_validateData()){
            ...
            if($semestre != "" && $carrera != ""){
                ...
                return redirect()->back()->withInput()->with("errors", $this->validation->getErrors())
                                                      ->with("grupos", $GruposModel->get_by($carrera, $semestre));
            }else{
                return redirect()->back()->withInput()->with("errors", $this->validation->getErrors());
            }
        }
    ...
    public function grupos(){
        ...
        if(!$grupos = $GruposModel->get_by($id_carrera, $semestre)){
