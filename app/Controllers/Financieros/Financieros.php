...
class Financieros extends BaseController
{
    ...
    public function listAspirantes(): void
    {
        ...
        $this->twig->display('RecursosFinancieros/aspirantes_todos', $data);
    }

    public function listAspirantesPagados(): void
    {
        // Obtenemos los datos necesarios
        $aspiranteModel = new AspiranteModel();
        ...
        $this->twig->display('RecursosFinancieros/aspirantes_pagados', $data);
    }

    public function listAspirantesPendientes(): void
    {
        // Obtenemos los datos necesarios
        $aspiranteModel = new AspiranteModel();
        ...
        $this->twig->display('RecursosFinancieros/aspirantes_pendientes', $data);
    }
}
