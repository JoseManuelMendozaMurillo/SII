...
function validateRegisterCandidate()
{
    ...
    $validation->setRules([
        ...
        'curp' => [
            'rules' => 'required|alpha_numeric|is_unique[alumnos.curp]', //campo de prueba
            'errors' => [
        ...
        'email' => [
            'rules' => 'required|valid_email|is_unique[alumnos.email]', //campo de prueba
            'errors' => [
